...
{The study employed Bayesian procedures due to three primary properties.
...
needed) in order to appropriately align the words. {For more details on
...
with the entropy scores. {The negative relationship explicitly
