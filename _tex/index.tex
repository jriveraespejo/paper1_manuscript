...
\begin{abstract}
{When investigating unobservable and complex traits, data collection and
aggregation processes can introduce distinctive features to the data
such as boundedness, measurement error, clustering, and the possible
presence of outliers and heteroscedasticity. Failure to collectively
address these features can result in numerous statistical challenges
that prevent the investigation of hypotheses regarding these traits.
...
in handling entropy score features when exploring research hypotheses
...
purposes. {Entropy scores were calculated from words of the first
...
Transcriptions are in Belgian Dutch followed by their English
translation. \emph{{[}B{]}} represent a blank space, and \emph{{[}X{]}}
an unidentifiable speech.}\label{tbl-alignment}\tabularnewline
\toprule\noalign{}
...
{This study compared the fitted models using three criteria: the
...
{This research question illustrated how hypotheses on intelligibility
