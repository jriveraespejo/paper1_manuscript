...
+-------+---------+--------------+---------+----------------+-------------+-------------------+
: Fitted models. [*Note:* Yes indicates the feature or parameter was included in the model, No indicates the oposite.]{style="color:blue;"} {#tbl-fitted .striped .hover}
...
#| fig-cap: 'WAIC and PSIS model comparison plot. *Note:* Black and blue points describe posterior means, and continuous horizontal lines indicate the associated uncertainty.'
#| fig-height: 4
#| fig-width: 10
...
```{r}
#| label: tbl-rq1-waic
#| tbl-cap: 'WAIC comparison for selected models. [*Note:* Table sorted from most to least plausible models for the data.]{style="color:blue;"}'
...
```{r}
#| label: tbl-rq1-psis
#| tbl-cap: 'PSIS comparison for selected models. [*Note:* Table sorted from most to least plausible models for the data.]{style="color:blue;"}'
...
```{r}
#| label: tbl-rq3-waic
#| tbl-cap: 'WAIC comparison for all models. [*Note:* Table sorted from most to least plausible models for the data.]{style="color:blue;"}'
...
```{r}
#| label: tbl-rq3-psis
#| tbl-cap: 'PSIS comparison for all models. [*Note:* Table sorted from most to least plausible models for the data.]{style="color:blue;"}'
