...
#| fig-cap: 'Entropy scores prediction for selected models. *Note:* Black dots show manifest entropy scores where darker points indicate greater overlap, orange dots and vertical lines show the posterior mean and 95% HPDI derived from Model 4, blue dots and vertical lines show similar information from Model 10.'
#| fig-height: 6
#| fig-width: 10
...
```{r}
#| label: tbl-rq1-waic
#| tbl-cap: "WAIC comparison for selected models. *Note:* Table sorted from most to least plausible model. Italic rows highlight the most plausible models for the data."
...
```{r}
#| label: tbl-rq1-psis
#| tbl-cap: "PSIS comparison for selected models. *Note:* Table sorted from most to least plausible model. Italic rows highlight the most plausible models for the data."
...
```{r}
#| label: tbl-rq3-waic
#| tbl-cap: "WAIC comparison for all models. *Note:* Table sorted from most to least plausible model. Italic rows highlight the most plausible models for the data."
...
```{r}
#| label: tbl-rq3-psis
#| tbl-cap: "PSIS comparison for all models. *Note:* Table sorted from most to least plausible model. Italic rows highlight the most plausible models for the data."
...
#| fig-cap: 'Entropy scores prediction for selected models. *Note:* Black dots show manifest entropy scores where darker points indicate greater overlap, orange dots and vertical lines show the posterior mean and 95% HPDI derived from Model 6, blue dots and vertical lines show similar information from Model 12.'
#| fig-height: 6
#| fig-width: 10
